...
<div align="center">
  <img src="https://raw.githubusercontent.com/YanYuCloudCube/YYC3-FAmily-Pai/main/public/Family-π³.png" alt="YYC³ Family" width="100%" style="max-width: 896px; border-radius: 12px;" />
</div>
...
<p align="center">
  ...
  <a href="https://github.com/YanYuCloudCube/YYC3-FAmily-Pai/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@yyc3/i18n-core.svg?style=flat-square&color=brightgreen" alt="MIT License" /></a>
  <br/>
...
[YYC³-CLI](https://github.com/YanYuCloudCube/YYC3-FAmily-Pai) 是 YYC³ 生态的**文档全生命周期生成引擎**（v2.0.0），负责项目初始化、标准化文档生成、DevOps运维。`@yyc3/i18n-core` 与其形成以下协同：
